        ...
        <div class="row border-bottom">
            ...
            <div class="col-lg-10">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item">
                        <a href="user-detail.php">User List</a>
                    </li>
                            ...
                            <form id="submit" action="#" class="wizard-big" method="post" name="submit">
                                    <fieldset>
                                          <div class="form-group row"><label class="col-sm-2 col-form-label">First Name:</label>
                                                <div class="col-sm-10"><input name='firstname' readonly="true" id="firstname" class="form-control white_bg" value="<?php echo $row['FirstName']; ?>">


   </div>
                                            </div>
                                            <div class="form-group row"><label class="col-sm-2 col-form-label">Last Name:</label>
                                                <div class="col-sm-10"><input type="text" readonly="true" class="form-control" name="lastname" value="<?php echo $row['LastName']; ?>"></div>
                                            </div>
