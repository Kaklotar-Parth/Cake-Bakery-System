...
<head>
    ...
    <title>Cake Bakery  | Delivered Orders</title>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title"><i class="fa fa-check-circle"></i> Delivered Orders</h4>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        // Debug: Check if there are any delivered orders
                                        $numRows = mysqli_num_rows($ret);
                                        if ($numRows == 0) {
                                            echo "<tr><td colspan='6' class='text-center'>No delivered orders found.</td></tr>";
                                        }
