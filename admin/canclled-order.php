...
<head>
    ...
    <title>Cake Bakery  | Cancelled Orders</title>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title"><i class="fa fa-times-circle"></i> Cancelled Orders</h4>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        // Debug: Check if there are any cancelled orders
