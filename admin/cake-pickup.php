...
<head>
    ...
    <title>Cake Bakery  | Orders Ready for Pickup</title>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title"><i class="fa fa-shopping-bag"></i> Orders Ready for Pickup</h4>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        // Debug: Check if there are any orders ready for pickup
                                        $numRows = mysqli_num_rows($ret);
                                        if ($numRows == 0) {
                                            echo "<tr><td colspan='6' class='text-center'>No orders ready for pickup.</td></tr>";
                                        }
