...
<?php
    $oid   = $_GET['oid'];
        $query = mysqli_query($con, "select tblorderaddresses.OrderTime,tblfood.Image,tblfood.ItemName,tblorders.Weight,tblorders.Price,tblorders.FoodId,tblorders.OrderNumber,tblorders.Quantity from tblorders
