<?php
    ...
    if (isset($_POST['submit'])) {
        ...
        if ($query) {
            echo "<script>alert('Cake has been added in to the cart.Your order is delivered in 5 to 6 hours. If you want cancel order call us +91635373207');</script>";
        } else {
...
<head>
    ...
    <title>cake bakery  - Our cakes</title>
    ...
    <section class="featured-section">
        <div class="container">
            <div class="section-title">
                <h2>Our features cakes</h2>
                <p>Indulge in our delectable collection of traditional Indian cakes, handcrafted with pure ingredients and authentic recipes</p>
            </div>
