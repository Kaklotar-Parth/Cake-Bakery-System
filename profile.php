<?php
    ...
    if (strlen($_SESSION['fosuid'] == 0)) {
        ...
        if (isset($_POST['submit'])) {
            ...
            $query = mysqli_query($con, "update tbluser set FirstName='$fname', LastName='$lname',Email='$email' where ID='$sid'");
...
<head>
    ...
    <title>cake bakery  - Profile</title>
    ...
    <style>
        ...
        @media (max-width: 767.98px) {
            ...
            .profile-card, .contact-info-card {
                padding: 20px;
            }
        }
    </style>
                        ...
                        <form action="" method="post">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="mobilenumber" name="mobilenumber" 
                                       value="<?php echo $row['MobileNumber']; ?>" readonly>
                            </div>
                            <div class="mb-3">
                                <label class="form-label">Registration Date</label>
                                <input type="text" class="form-control" id="regdate" name="regdate" 
                                       value="<?php echo $row['RegDate']; ?>" readonly>
                            </div>
                            <?php } ?>
